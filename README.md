...
- A gradeable beginner project in D3 with detailed rubric and build in editor built on:
    - https://github.com/ZacharyWartell/zjw-generic-instructions (Architect/Programmer: Zachary Wartell)
